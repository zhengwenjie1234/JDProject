...
import com.baway.jdproject.alpayutil.PayResult;
import com.baway.jdproject.alpayutil.SignUtils;
...
public class PayMethodActivity extends BaseActivity implements View.OnClickListener {
    ...
    //阿里云服务器，用真机测试
    //private static final String URL_JSON = "http://169.254.249.24:8080/PayServer/AlipayDemo";
...
//	private static final String URL_JSON = "http://169.254.63.148:8080/alipayServer/AlipayDemo";
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        Toast.makeText(PayMethodActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                    } else {
                        // 判断resultStatus 为非"9000"则代表可能支付失败
                        // "8000"代表支付结果因为支付渠道原因或者系统原因还在等待支付结果确认，最终交易是否成功以服务端异步通知为准（小概率状态）
                        if (TextUtils.equals(resultStatus, "8000")) {
                            Toast.makeText(PayMethodActivity.this, "支付结果确认中", Toast.LENGTH_SHORT).show();
    ...
    private void paySignFromServer() {
        ...
        //String url = "http://169.254.249.24:8800/PayServer/AlipayDemo";
   ...
   private void wechatPay(String order_sn) {
    ...
    protected void initView() {
        ...
        mBtZfb = (Button) findViewById(R.id.bt_zfb);
        mBtZfb.setOnClickListener(this);
        mBtWx = (Button) findViewById(R.id.bt_wx);
        mBtWx.setOnClickListener(this);
